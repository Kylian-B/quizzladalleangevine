                ...
                <div class="modal-body text-center row ">
                    <div class=" row ">
                        <div class="quiz" id="quiz" data-toggle="buttons">
                            <label class="col-6 mt-2 element-animation1 btn btn-lg btn-danger btn-block"><span
                            ...
                            <label class="col-6 mt-2 element-animation2 btn btn-lg btn-danger btn-block"><span
                                    class="btn-label"><i class="glyphicon glyphicon-chevron-right"></i></span> <input
                                    type="radio" name="q_answer" value="2">{{ $quiz->false1 }}</label>
                            <label class="col-6 mt-2 element-animation3 btn btn-lg btn-danger btn-block"><span
                                    class="btn-label"><i class="glyphicon glyphicon-chevron-right"></i></span> <input
                                    type="radio" name="q_answer" value="3">{{ $quiz->false2 }}</label>
                            <label class="col-6 mt-2 element-animation4 btn btn-lg btn-danger btn-block"><span
                                    class="btn-label"><i class="glyphicon glyphicon-chevron-right"></i></span> <input
